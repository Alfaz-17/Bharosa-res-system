      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-border animate-in zoom-in-95 duration-300">
        <div className="flex items-center justify-between border-b border-border bg-gray-50/50 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-black text-gray-900 uppercase tracking-tight">Add Staff Member</h3>
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Create a new system user</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
          ...
          <div className="pt-4 flex space-x-3">
            ...
            >
              ...
              {createUser.isPending ? "Connecting..." : "Create Account"}
            </button>
          </div>
        </form>
      </div>
